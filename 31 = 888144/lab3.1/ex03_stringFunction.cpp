...
int main() {
	...
	str3.clear(); //Line 10
	cout << "Line 11: After clear, str3: " << str3 << endl; //Line 11
	cout << "Line 12: str1.empty(): "
		<< str1.empty() << endl; //Line 12
	cout << "Line 13: str2.empty(): "
		<< str2.empty() << endl; //Line 13
	cout << "Line 14: str4: " << str4 << endl; //Line 14
	str4.erase(11, 4); //Line 15.1
	cout << "Line 15: str5: " << str4 << endl;
	str4.erase(1,2); //Line 15.2
