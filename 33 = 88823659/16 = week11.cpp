		...
		void LOGIN(){
			...
			do{
				...
				if(use1 == "99" && pass1 == "99"){ 
					...
					cout<<"\n -- Sorry you don't have permission to access -- "<<endl;
...
class DoubleLinkedList {
	...
	public  :
		...
		void read(){
			ifstream myFile("student11.dat",ios::in);
			string  id;
			string  year;
			string  pre;
			string  fname;
			...
			string  Sta;
			string  dmy;
			while (myFile>>id>>pre>>year>>fname>>lname>>gpa>>branch>>generation>>Adv>>Sta>>dmy){
