...
<CENTER>
  <div class="col-md-12">  <!-- เมนูหลัก -->
    ...
    <div class="col-md-12">       <!-- เริ่มโชว์ด้านซ้าย -->
        ...
        <form name="form1" method="post" action="history_process.php" target="targetf">
            <div class="col-md-4">
						<BR><BR>
                <div class="panel">
                    <div class="panel demo-lime" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
											    <div class="panel panel-blue" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
													    <div class="panel-heading">
															    <h2> <font face = "TH Sarabun New" besefont size = "5">  แสดงประวัติ </font> </h2>
													    </div>
											    </div>
                              <td>&nbsp;&nbsp;&nbsp;&nbsp;</tb>
                              <select name="account" id="account">
                              		...
                              		?>
                              					<option value="<?php echo $objResult['account_num'];?>"><?php
									  										echo $objResult['account_num']." - ".$objResult['balance'];?></option>
									  							<?php } ?>
									  					</select>
                              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tb>
                              <input type="submit" name="Submit" value="แสดง">
                              <td>&nbsp;&nbsp;&nbsp;</tb>
                  ...
                  <BR><BR>
								...
								<script>
										function changeContent(){
													document.getElementById('targetf').innerHTML = window.frames['targetf'].document.getElementsByTagName('html')[0].innerHTML;
										}
								</script>
								<div id = "targetf">
						  <BR><td>&nbsp;&nbsp;&nbsp;</tb>
							  </div>
                <iframe id="targetf" name="targetf" src="" onLoad = "changeContent()"	style = "height:0; width:0; border-width:0;"></iframe>
             </div>
          </from>
