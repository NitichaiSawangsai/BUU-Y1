            ...
            <div class="panel">
                <div class="panel panel-blue" style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);">
                    <div class="panel-heading">
                        <h2> <font face = "TH Sarabun New" besefont size = "5">  ถอนเงิน </font> </h2>
                    </div>
                </div>

            <form name="form" method="post" action="withdraw_process.php" >
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tb>
              ...
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tb>
              <input type="text"  name="withdraw_process_money"  placeholder="#จำนวนที่จะทอนเงิน" >
						<BR><BR>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tb>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tb>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</tb>
