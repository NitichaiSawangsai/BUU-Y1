...
var burl='textbutton.gif';     // URL OF BUTTON GRAPHIC
var bw=21;                 // BUTTON GRAPHIC WIDTH
var bh=20;                 // BUTTON GRAPHIC HEIGHT
...
var SL=[ 
["http://www.ac120.co-ltd.com" ,  "WEB AC 120" , "" ],
["http://www.gazib.com" ,  "GAZIB" , "" ],
...
t+=(ns4)?'<layer  height='+(Sh-2)+' width='+bw+' left=1 top=1 bgcolor="'+Sbg+'"></layer>':'<div style="position:absolute; height:'+(Sh-2)+'px; width:'+bw+'px; top:1px; left:1px; background-color:'+Sbg+'"></div>';
...
t+=(ns4)?'<layer name="sliderB" top=1 left=1 height='+bh+' width='+bw+'>':'<div id="sliderB" style="position:absolute; top:1px; left:1px; height:'+bh+'px; width:'+bw+'px; cursor:hand">';
t+='<img src="'+burl+'" width='+bw+' height='+bh+'>';
